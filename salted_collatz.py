...
class SaltedCollatz:
    def __init__(self,x):
        ...
        self.ei_upperLimit = 50		# max value for salt poly coefficient
    ...
    def next(self):
        self.yr = self.yr + self.e1 - self.sr
        
        if self.yr % 2 == 1:
            self.yr = (self.a1 * self.yr + self.a2 * self.e2) // self.a3 + self.s0
        else:
            self.yr = (self.a4 * self.yr + self.a5 * self.e3) // self.a6 + self.s1
